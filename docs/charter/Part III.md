...
> **Draft status.** This Part applies the principles and constraints established in [Part B of the Founding Book](../founding-book/Part%20B.md) to safety, restoration, protective intervention, and defense mechanisms. Its details remain proposals until they are threat-modeled, tested where appropriate, independently reviewed, and ratified.
